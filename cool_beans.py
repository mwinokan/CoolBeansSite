...
MOVIES.append(
    Movie(
        name="bram",
        title="AN ACT OF DEFIANCE / BRAM FISCHER",
        # year=2021,
        imdb_url=None,  # "https://www.imdb.com/title/tt6570098/",
...
MOVIES.append(
    Movie(
        ...
        # year=2021,
        imdb_url=None,  # "https://www.imdb.com/title/tt6570098/",
        description="""The inside story of the planning, execution, rousing aftermath, and ultimate downfall of the kidnappers of beer tycoon Alfred "Freddy" Heineken in 1983, which resulted in the largest ransom ever paid for an individual.<br><br>
""",
        awards=[
...
""",
        ...
        trailer_url="https://youtu.be/Fr-Op9-HZhA",
        more_data={
            "YEAR / FORMAT": "2010 / LIVE ACTION / FEATURE FILM",
...
MOVIES.append(
    Movie(
        ...
        # year=2021,
        imdb_url=None,  # "https://www.imdb.com/title/tt6570098/",
        description="""After their mother dies, two boys flee their mean aunt and head for Venice, Italy, where they meet Scipio, the mysterious "Thief Lord." Along with a small gang of abandoned kids, the boys start robbing the rich to support themselves.<br><br>
""",
